...
var AxiosExtend = /*#__PURE__*/function () {
  function AxiosExtend(_a) {
    var maxConnections = _a.maxConnections,
        ...
        defaultOptions = __rest(_a, ["maxConnections", "orderly", "unique", "retries", "onCancel"]); // static test = 888


    this.waiting = []; // 请求队列

    this.maxConnections = 0; // 最大连接数，默认：0=不限制

    this.orderly = true; // 是否有序返回，默认：true

    this.unique = false; // 是否取消前面的相似请求，默认：false
    ...
    this.retries = retries !== null && retries !== void 0 ? retries : 3;
  ...
  _proto.init = function init(defaultOptions) {
    ...
    onResponse && axios__default['default'].interceptors.response.use(onResponse, function (err) {
          ...
          while (1) {
            switch (_context.prev = _context.next) {
              ...
              case 9:
                _context.prev = 9;
                _context.next = 12;
                return this.waiting.splice(len, 1)[0].promise;
              ...
              case 19:
                ...
                _context.prev = 20;
                _context.next = 23;
                return this.waiting.shift().promise;
